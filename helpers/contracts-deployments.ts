...
export const deployMockTokenInterceptor = async (addressesProvider: string, verify?: boolean) =>
  withSaveAndVerify(
    await new MockTokenInterceptorFactory(await getDeploySigner()).deploy(addressesProvider),
