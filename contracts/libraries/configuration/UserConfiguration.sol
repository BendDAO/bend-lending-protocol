...
library UserConfiguration {
   ...
   **/
  function isReserveBorrowing(DataTypes.UserConfigurationMap memory self, uint256 reserveIndex)
    internal
    pure
    returns (bool)
  {
   ...
   * @return True if the user has been borrowing any reserve, false otherwise
   **/
  function isReserveEmpty(DataTypes.UserConfigurationMap memory self) internal pure returns (bool) {
   ...
   **/
  function isUsingNftAsCollateral(DataTypes.UserConfigurationMap memory self, uint256 nftIndex)
    internal
    pure
    returns (bool)
  {
   ...
   **/
  function isNftEmpty(DataTypes.UserConfigurationMap memory self) internal pure returns (bool) {
