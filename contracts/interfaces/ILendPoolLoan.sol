...
interface ILendPoolLoan {
  ...
  function getLoanCollateral(uint256 loanId) external view returns (address, uint256);

  function getReserveBorrowScaledAmount(address reserveAsset) external view returns (uint256);
