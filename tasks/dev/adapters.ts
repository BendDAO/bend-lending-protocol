...
import { deployBendUpgradeableProxy, deployOpenseaAdapterImpl } from "../../helpers/contracts-deployments";
...
task("dev:deploy-adapters", "Deploy adapters")
  ...
  .setAction(async ({ verify, pool }, localBRE) => {
    ...
    const impl = await deployOpenseaAdapterImpl(verify);
